...
import com.god.mediastore.adapter.PhotoAdapter;
import com.god.mediastore.base.BaseFragmentActivity;
import com.god.mediastore.dialog.DialogLoading;
import com.god.mediastore.fagment.FragmentGallery;
import com.god.mediastore.fagment.TitleBarFragment;
import com.god.mediastore.listener.OnItemViewListener;
import com.god.mediastore.util.L;
import com.god.mediastore.util.PermissionUtil;
import com.god.mediastore.util.StorageDirectoryUtils;
...
public class PhotoActivity extends BaseFragmentActivity implements AdapterView.OnItemClickListener {
    ...
    public final static String CHECK_MAX = "checkCount";//能选中多少张
    public final static String CHECK_PATH = "check_path";//被选中的图片
    public final static String CAMERA_STATE = "check_camera";//是否显示相机
    public final static String DATA = "data";//返回值
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cameraState = intent.getBooleanExtra(CAMERA_STATE, true);//选择数量
    ...
    private void setData() {
        ...
        List<ArrayMap<String, String>> list = new ArrayList<>();//Camera,Screenshots
